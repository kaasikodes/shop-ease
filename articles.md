...
As promised this is the architectural diagram. Lets discuss the diagram before proceeding to define the services and the deliverables expected from them.
...
- Here is an example of our docker-compose file.
- I'm sure you've noticed refeneces to some confiuration file you're not aware we'll dicuss them and their contents further in an upcoming topic. For the time being what you need to know is that tempo-config.yaml, loki-config.yaml, and prometheus-yaml, and loki-config define .....
...
- You can take a look here to get a look at what our repository will look like ...
